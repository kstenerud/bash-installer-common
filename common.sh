# Bash helper functions for installing things

# To include this in your own script:
#     source /path/to/common.sh

# To get a real path to your script's directory:
...
install_snaps()
{
    ...
    for snap_pkg in $snaps; do
        sudo snap install $(echo $snap_pkg | sed 's/:/ --/g')
    done
}
